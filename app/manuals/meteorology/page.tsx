    ...
    <main className="min-h-screen bg-[#06111f] px-4 py-10 text-white sm:px-6">
      <section className="mx-auto max-w-3xl">
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-medium text-[#f4b400] transition hover:text-white"
        >
          <ArrowLeft size={16} />
          Back to Meteorology
        </Link>

        <div className="mt-8 rounded-3xl border border-[#1e3a5f] bg-[#081726] p-6 shadow-2xl sm:p-8">
