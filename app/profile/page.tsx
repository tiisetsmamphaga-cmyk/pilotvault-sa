    ...
    return (
      <main className="min-h-screen bg-[#06111f] px-4 py-10 text-[#071426] sm:px-6">
        <div className="mx-auto max-w-xl">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-sm font-semibold text-white transition hover:text-[#f4b400]"
          >
            <ArrowLeft size={16} />
            Back to Dashboard
          </Link>
      ...
      <section className="mx-auto max-w-xl px-4 pb-12 pt-6 sm:px-6 sm:pb-16 sm:pt-10">
        <div className="flex items-center justify-between gap-4">
          <Link
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-[#071426] shadow-[0_6px_18px_rgba(15,23,42,0.08)] transition hover:-translate-x-0.5 hover:bg-[#f4b400]"
          >
            <ArrowLeft size={19} />
          </Link>
        ...
        <div className="mt-5 flex min-w-0 items-center gap-4 px-1">
          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full border-2 border-[#f4b400] bg-[#071426] text-xl font-bold text-white shadow-[0_8px_24px_rgba(244,180,0,0.18)]">
            {initials}
          </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 truncate text-sm text-[#b9c1cb]">
              {formatPlan(profile.subscription_plan)}
            </p>
            <div className="mt-2 flex flex-wrap gap-2">
              <span className="rounded-full bg-[#f4b400] px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-[#071426]">
      ...
      {editProfileOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-[#071426]/45 px-0 pt-10 backdrop-blur-[2px] sm:items-center sm:px-4 sm:py-6">
          <div className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-t-[28px] border border-[#e2e6eb] bg-white p-5 text-[#071426] shadow-2xl sm:rounded-[28px] sm:p-6">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#b47f00]">
                  Edit Profile
                </p>
            ...
            <div className="mt-7 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-[#f4b400] px-4 py-3 text-sm font-bold text-[#071426] transition hover:bg-[#ffc31a] disabled:opacity-60"
              >
