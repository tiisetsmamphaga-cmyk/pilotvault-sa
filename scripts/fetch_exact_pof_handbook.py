...
SOURCES = [
    ("https://air.flyingway.com/books/ac_61-23c_phak_canada.pdf", True),
    ("http://air.flyingway.com/books/ac_61-23c_phak_canada.pdf", True),
    ("https://www.mlettini.com/princilpes%20of%20flight.pdf", False),
]
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        for url, require_exact_full_hash in SOURCES:
            if tmp.exists():
                tmp.unlink()
